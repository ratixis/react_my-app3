...
function PremYyMODISCalendar (){
    ...
    async function component (e)  {
        ...
        try {
          var response = await axios.get(`http://localhost:5166/api/contents/meteo/${date}/MODIS`,
         { responseType: 'blob',
...
}export default PremYyMODISCalendar;